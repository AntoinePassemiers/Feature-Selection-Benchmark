...
METHOD_NAMES = ['nn', 'rf', 'fsnet', 'lassonet', 'cae', 'canceloutsigmoid', 'canceloutsoftmax', 'deeppink']

for method_name in METHOD_NAMES:

    for DATASET in {'isolet', 'mice', 'har', 'fashion', 'mnist', 'coil20'}:
